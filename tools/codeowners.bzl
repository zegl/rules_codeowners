...
while [ "$#" -gt 0 ]; do
    ...
    cat "$file" | \
        ...
        """.replace("_HEADER_LINES_", "\n".join(["# %s" % line for line in ctx.attr.header_lines])),
    )
...
""",
    attrs = {
        "header_lines": attr.string_list(
            doc = "Lines to insert at the top of the generated file (as comments)",
            default = [
                "This file was generated by rules_codeowners / Bazel. Don't edit it directly",
            ],
        ),
